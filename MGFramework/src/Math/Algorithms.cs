...
namespace FavobeanGames.MGFramework.Math
{
    public static class Algorithms
    {
        ...
        {
            return SysMath.Sqrt(SysMath.Pow(p1.X - p2.X, 2) + SysMath.Pow(p1.Y - p2.Y, 2));
        }
        ...
        {
            return SysMath.Sqrt(SysMath.Pow(p1.X - p2.X, 2) + SysMath.Pow(p1.Y - p2.Y, 2) + SysMath.Pow(p1.Z - p2.Z, 2));
        }
        ...
        {
            return SysMath.Atan2(p2.Y - p1.Y, p2.X - p1.X);
        }
