...
namespace FavobeanGames.Components
{
    ...
    public class Camera
    {
        ...
        public Camera(Screen screen, CameraOptions options)
        {
            if (screen is null)
            {
        ...
        public void UpdateMatrices()
        {
            ...
            switch (CameraOptions.ProjectionType)
            {
                ...
                case CameraProjectionType.Orthographic:
                    ...
                    proj = Matrix.CreateOrthographic(Screen.Width, Screen.Height, MinZ, MaxZ);
                    break;
                default:
        ...
        public void MoveTo(Vector2 newPostion)
        {
            ...
            // if (LockCameraToScreen)
            // {
            //     postion = Math.Clamp(postion, screen)
            // }
        }
